...
import com.ckdl.entity.ifaddgoods;
...
public class BrandController {
    ...
    //分页
    @GetMapping("/findpage")
    public PageInfo<Brand> findpage(@RequestParam(value = "page") int page, @RequestParam(value = "size") int size){
    ...
    public ifaddgoods addgoods(@RequestBody Brand brand){
        brandServiceimpl.addgoods(brand);
        return new ifaddgoods();
    }
    //修改商品
